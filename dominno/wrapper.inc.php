                            ...
                            <div class="row">
                                <div class="col-lg-7 col-md-6 col-sm-6 hidden-xs">
                                	<div class="header-top-info">
                                		...
                                		<span class="ml-8">{{_var.phone}}</span>
                                	</div>
                                	<div class="header-top-info">
                                		<img src="images/icons/h-envelope.png" alt="">
                                		<span class="ml-8">{{_var.email}}</span>
                                	</div>
                                </div>
													...
													<div class="login-form">
														...
														<form action="/signin" method="post">
															<div class="input-box mb-19">
																...
																<input type="text" name="l" placeholder="Логин">
															</div>
															<div class="input-box">
															...
															<div class="button-box">
																<button type="submit" class="register-btn button lemon pull_right">Войти</button>
															</div>
														</form>
													</div>
												</li>
                        ...
                        <div class="container">
                            <div class="row">
                                <div class="col-lg-12 col-md-12 col-sm-12">
                                    <div class="mobile-menu"  data-wb="role=include&template=menu-mobile.inc.php">
                            ...
                            <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                                <div class="single-footer-widget pull_right">
                                    ...
                                    <div class="footer-contact-info mb-24">
                                    	...
                                    	<span class="pl-40 block">
                                    	Телефон : {{_var.phone}}</span>
                                    </div>
                                    <div class="footer-contact-info">
                                    	<img src="images/icons/f-globe.png" alt="">
                                    	<span class="pl-40 block">Email : {{_var.email}}<br>
                                    	Web : {{_route.host}}</span>
                                    </div>
                                </div>
                            </div>
                        </div>
