...
<head>
	...
	<meta name="twitter:site" content="https://twitter.com/_IvanGrozdic" />
...
<body>
	...
	<nav id="menu-wrap" class="menu-back cbp-af-header">
			...
			<div class="container">
				<div class="row">
					<div class="col-6 px-0 px-md-3 pl-1 py-3">
						<span class="call-top">Звоните:</span> <a href="#" class="call-top">{{_var.phone}}</a>
					</div>
		...
		<div class="menu">
			...
			<ul class="main-menu text-right" data-wb="role=tree&item=mainmenu">
